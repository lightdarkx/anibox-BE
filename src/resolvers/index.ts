...
export const resolvers = {
  Query: {
    ...
    showLists: async (_, args) =>
      getShowsFromWatchList(args.user_id, args.list_id),
    reviews: async (_, args) => getReviews(args.show_id),
    reviewsFriends: async (_, args) =>
      getFriendsReviews(args.user_id, args.show_id),
